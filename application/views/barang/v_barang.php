...
<html>
            ...
            <div class="box box-info">
              <div class="box-header">
                <div class="pull-left">
                  ...
                  <button class="btn btn-warning btn-flat add-btn" onclick="add_data()" ><i class="fa fa-plus"></i> Tambah</button>
                </div>
  ...
  // var table_id = table.cell( idx, 1).data()

  function refresh() {
      table.ajax.reload(null, false);
      idx = -1;
      console.log(table.cell( idx, 1).data())
  }
